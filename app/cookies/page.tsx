...
export const metadata: Metadata = {
  title: "Cookie Policy",
  description: "Content Trace cookie policy — how we use cookies and third-party tracking on our free AI content detection tool.",
  ...
  return (
    <><Nav current="/cookies" />
      ...
      {[
        ...
        { title: "How We Use Cookies", body: `Content Trace itself uses minimal cookies required for the site to function. However, third-party services embedded on our site may set their own cookies.` },
        ...
        { title: "Managing Cookies", body: `You can control cookies through your browser settings — most browsers allow you to view, delete, and block cookies. Note that disabling certain cookies may affect Content Trace functionality or ad display.` },

...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "How to Humanize AI Content: A Practical Guide | TelltaleProof",
...
export default function Article3() {
  return (
    <main style={{ maxWidth: "700px", margin: "0 auto", padding: "60px 24px 80px", fontFamily: "var(--font)" }}>
      ...
      <div style={{ fontSize: "14px", color: "var(--text-muted)", fontFamily: "var(--font-mono)", marginBottom: "40px" }}>March 10, 2026 · 8 min read · By Web Thrive, LLC</div>

...
export const metadata: Metadata = {
  ...
  description: "Telltale Proof privacy policy — how we collect, use, and protect your information when you use our free AI content detection tool.",
  alternates: { canonical: `${SITE_URL}/privacy` },
  openGraph: {
    title: "Privacy Policy | Telltale Proof",
    description: "How Telltale Proof handles your data and privacy.",
  ...
  return (
    <><Nav current="/privacy" />
      ...
      {[
        ...
        { title: "8. Children's Privacy", body: `Telltale Proof is not directed at children under 13. We do not knowingly collect personal information from children under 13.` },
        { title: "9. Changes to This Policy", body: `We may update this Privacy Policy from time to time. Continued use of Telltale Proof after changes constitutes acceptance of the updated policy.` },
